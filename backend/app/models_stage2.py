...
class Event(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("start_date < end_date OR end_date IS NULL", name="valid_event_dates"),
...
User.conversations_created = relationship("Conversation", foreign_keys="Conversation.created_by", back_populates="creator")
User.conversation_participations = relationship("ConversationParticipant", back_populates="user")
User.messages = relationship("Message", back_populates="user")
User.events_created = relationship("Event", foreign_keys="Event.created_by", back_populates="creator")
