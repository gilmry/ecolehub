    ...
    def handle_webhook(self, payment_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if payment.status == "paid":
                logging.info(f"💰 Payment successful for EcoleHub: {payment_id} - {payment.amount['value']} EUR")
    ...
    def get_supported_methods(self) -> list:
        ...
        try:
            ...
            for method in methods:
                if method.id in ["bancontact", "ideal", "creditcard", "paypal", "banktransfer"]:
                    belgian_methods.append({
                        "id": method.id,
                        "description": method.description,
                        "image": method.image,
                        "min_amount": float(method.minimum_amount["value"]) if method.minimum_amount else 0,
                        "max_amount": float(method.maximum_amount["value"]) if method.maximum_amount else 999999
                    })
            ...
            return [
                {"id": "bancontact", "description": "Bancontact", "min_amount": 0.31, "max_amount": 50000},
                {"id": "creditcard", "description": "Carte de crédit", "min_amount": 0.31, "max_amount": 10000},
                {"id": "paypal", "description": "PayPal", "min_amount": 0.31, "max_amount": 8000}
            ]
