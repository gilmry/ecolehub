...
class User(Base):
    ...
    sel_services = relationship("SELService", back_populates="user", cascade="all, delete-orphan")
    transactions_sent = relationship("SELTransaction", foreign_keys="SELTransaction.from_user_id", back_populates="from_user")
    transactions_received = relationship("SELTransaction", foreign_keys="SELTransaction.to_user_id", back_populates="to_user")
    sel_balance = relationship("SELBalance", uselist=False, back_populates="user", cascade="all, delete-orphan")
